...
(function (global, factory) {
...
})(typeof window !== 'undefined' ? window : undefined, function (window, document, undefined, framework) {
    'use strict';
    ...
    var COMPATIBILITY = function () {
        ...
        function bind(func, thisObj) {
            if ((typeof func === 'undefined' ? 'undefined' : _typeof(func)) != TYPES.f) {
        ...
        function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
            ...
            function setupResponsiveEventListener(element, eventNames, listener, remove, passive) {
                ...
                if (collected) {
                    ...
                    for (; i < events[LEXICON.l]; i++) {
                        if (_supportPassiveEvents) element[0][method](events[i], listener, { passive: passive || false });else element[onOff](events[i], listener);
                    }
                }
            }
            ...
            */
            function setupHostMouseTouchEvents(destroy) {
                ...
                setupResponsiveEventListener(_hostElement, [_strMouseTouchEnter, _strMouseTouchLeave], [hostOnMouseEnter, hostOnMouseLeave], _scrollbarsAutoHideMove ? true : destroy, true);
            ...
            function isUnknownMutation(mutation) {
                ...
                if (mutationType === 'attributes' && (attributeName === LEXICON.c || attributeName === LEXICON.s) && !_isTextarea) {
                    ...
                    if (attributeName === LEXICON.c && FRAMEWORK(mutationTarget).hasClass(_classNameHostElement)) return hostClassNamesChanged(mutation.oldValue, mutationTarget.getAttribute(LEXICON.c));
            ...
            *  }
            ...
            function update(updateHints) {
                ...
                if (widthAuto) {
                    if (!cssMaxValue.cw) contentElementCSS[_strMaxMinus + _strWidth] = _strEmpty;
                ...
                if (heightAuto) {
                    if (!cssMaxValue.ch) contentElementCSS[_strMaxMinus + _strHeight] = _strEmpty;
                ...
                if (hostSizeChanged || contentSizeChanged || textareaSizeChanged || cssDirectionChanged || boxSizingChanged || paddingAbsoluteChanged || widthAutoChanged || widthAuto || heightAutoChanged || heightAuto || cssMaxValue.c || ignoreOverlayScrollbarHidingChanged || overflowBehaviorChanged || clipAlwaysChanged || resizeChanged || scrollbarsVisibilityChanged || scrollbarsAutoHideChanged || scrollbarsDragScrollingChanged || scrollbarsClickScrollingChanged || textareaDynWidthChanged || textareaDynHeightChanged || textareaAutoWrappingChanged) {
                    ...
                    if (sizeAutoCapable) {
                        ...
                        var setContentGlueElementCSSfunction = function setContentGlueElementCSSfunction(horizontal) {
                            ...
                            if (!autoSize || !autoSize && border.c) contentGlueElementCSS[strWH] = hostSize[wh] - (_isBorderBox ? 0 : paddingSize + borderSize) - 1 - marginSize;

                            //if size is auto and host is same size as max size, make content glue size +1 to make sure size changes will be detected
                            if (autoSize && cssMaxValue['c' + wh] && cssMaxValue['i' + wh] === maxSize) contentGlueElementCSS[strWH] = maxSize + (_isBorderBox ? 0 : paddingSize) + 1;
                    ...
                    if (hideOverflow.y) addClass(_hostElement, _classNameHostOverflowY);else removeClass(_hostElement, _classNameHostOverflowY);
            ...
            function isHTMLElement(o) {
                ...
                o && (typeof o === 'undefined' ? 'undefined' : _typeof(o)) == TYPES.o && o !== null && o.nodeType === 1 && _typeof(o.nodeName) == TYPES.s;
            }
